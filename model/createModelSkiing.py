...
learning_rate = 0.001
train_data = "../00_Datasets/dataset_skipiste_crowded/traindata_brightness"
test_data = "../00_Datasets/dataset_skipiste_crowded/testdata_brightness"
...
model.save('model/trained_model_skicount_brightness.h5')
